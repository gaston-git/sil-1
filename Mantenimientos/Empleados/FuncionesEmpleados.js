$(document).ready(function () {
    ...
    $("#btnNuevo").click(function () {
        window.location.href = '/Mantenimientos/Empleados/Agregar.cshtml';
        return false;
    });

    $("#btnEditar").click(function () {
        if (idRegistro > 0)
            window.location.href = '/Mantenimientos/Empleados/Editar.cshtml?id=' + idRegistro;
        else
    ...
    $("#btnEliminar").click(function () {
        $.confirm({
            title: 'Confirmación',
            content: '¿Está seguro(a) de borrar el Empleado?',
            buttons: {
                Aceptar: function () {
                    if (idRegistro > 0)
                        window.location.href = '/Mantenimientos/Empleados/eliminar.cshtml?id=' + idRegistro;
                    else
