$(document).ready(function () {
    ...
    $("#btnNuevo").click(function () {
        window.location.href = '/Mantenimientos/Sistemas/Agregar.cshtml';
        return false;
    });

    $("#btnEditar").click(function () {
        if (idRegistro > 0)
            window.location.href = '/Mantenimientos/Sistemas/Editar.cshtml?id=' + idRegistro;
        else
    ...
    $("#btnEliminar").click(function () {
        $.confirm({
            title: 'Confirmación',
            content: '¿Está seguro(a) de borrar el Sistema?',
            buttons: {
                Aceptar: function () {
                    if (idRegistro > 0)
                        window.location.href = '/Mantenimientos/Sistemas/eliminar.cshtml?id=' + idRegistro;
                    else
