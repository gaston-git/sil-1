$(document).ready(function () {
    ...
    $("#btnNuevo").click(function () {
        window.location.href = '/Mantenimientos/Departamentos/Agregar.cshtml';
        return false;
    });

    $("#btnEditar").click(function () {
        if (idRegistro > 0)
            window.location.href = '/Mantenimientos/Departamentos/Editar.cshtml?id=' + idRegistro;
        else
    ...
    $("#btnEliminar").click(function () {
        $.confirm({
            title: 'Confirmación',
            content: '¿Está seguro(a) de borrar el Departamento?',
            buttons: {
                Aceptar: function () {
                    if (idRegistro > 0)
                        window.location.href = '/Mantenimientos/Departamentos/eliminar.cshtml?id=' + idRegistro;
                    else
